       ...
       <div class="row">
         <div class="col-lg-10 mx-auto">
           <h1>
            ...
            <a id="navi" href="#">
			  <img src="../../img/content/edit_img/page_img/navi_icon.png" width=50 height=50/>
			</a>
             </div>
             <!-- 길찾기 앱 바로가기 사용 여부 -->
             <div class="skin-info-find">
             	<a id="info-find-link" href="#" target="_blank">
			  <img src="../../img/content/edit_img/page_img/daum_icon.png" width=50 height=50 style="border-radius: 5px;"/>
			</a>
             </div>
             <!-- 약도 이미지 -->
             <span>약도 이미지</span>
