									...
									<div class="panel panel-success post panel-shadow">
										<div class="post-heading">
											...
											<div class="pull-left meta">
												...
												<h6 class="text-muted time">text쓴 시간</h6>
											</div>
										</div>
										<div class="post-description">
											<p>text,text</p>
											<div class="stats">
												<a href="#" class="btn btn-warning stat-item btn-block">
													<i class="glyphicon glyphicon-thumbs-up"></i>2
												</a> <a href="#" class="btn btn-danger stat-item btn-block">
													<i class="glyphicon glyphicon-comment"></i>12
												</a>
											</div>
										</div>
									</div>
								...
								<div class="single_pricing">
									<div class="pricing_body">
										<div href="#" type="button"
											class="btn btn-lg btn-success commentbtn">글쓰기</div>
									</div>
								</div>
							</div>
							<!-- End off 글쓰기 -->
