...
<h4 class="title text-left my-2">기능 소개</h4>
	<div class="row pb-3">
   	
    <!--part1-->
    	<div class="col-sm-6 col-lg-4 d-flex justify-content-center align-items-center function">
	    		<div class="rounded-circle">
	    			<img src="./img/info/function/service_bg/service_bg1.png">
	    			<div class="rounded-circle-inner d-flex align-items-center justify-content-center">
	    				<div>
