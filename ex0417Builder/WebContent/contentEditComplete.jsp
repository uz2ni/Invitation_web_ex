				...
				<article class="finish-box col-8 text-center">
					<div class="col">
						<div class="row justify-content-center py-5">
							...
							<!--이용순서-->
							<div class="procedure-box col-11 py-3" href="#">
  							...
  							<br><br>
								...
								<div class="d-flex d-flex justify-content-center pt-3" style="height:35vh;">
									<div class="col-3 px-3">
										<div class="procedure-box-inner">
											<a><img src="./img/content/complete/finish_1.JPG" height="100%;" width="100%"/></a>
										</div>
										<div class="procedure-box-text pt-3">먼저 원하는 초대장 종류를 선택 후 제작 신청합니다.</div>
									</div>
									<div class="col-3 px-3">
										<div class="procedure-box-inner">
											<a><img src="./img/content/complete/finish_2.JPG" height="100%;" width="100%"/></a>
										</div>
										<div class="procedure-box-text pt-3">신청 완료후 초대장을 만들기에 들어가 편집합니다.</div>
									</div>
									<div class="col-3 px-3">
										<div class="procedure-box-inner">
											<a><img src="./img/content/complete/finish_3.JPG" height="100%;" width="100%"/></a>
										</div>
										<div class="procedure-box-text pt-3">연락처를 입력하여 문자및 카톡을를 전송합니다.</div>
									</div>
									<div class="col-3 px-3">
										<div class="procedure-box-inner">
											<a><img src="./img/content/complete/finish_4.JPG" height="100%;" width="100%"/></a>
										</div>
										<div class="procedure-box-text pt-3">문자를 보낸 후 효율적인 행사 관리를 위해 통계페이지로 이동합니다.</div>
									</div>
								</div>
							</div>
							<!--이용순서_end-->
							...
							<div class="button-box col-12" style="height: 10vh" href="#">
								<div>
									<a href="sendMessage.do"><button type="button"
										...
										문자 보내기</button></a>
									<a id="kakao-link-btn" href="javascript:sendLink()"><button type="button"
											class="btn btn-complete-kakao">
										<img src="./img/content/complete/kakaotalk_icon_mini.png" height="20px" width="25pxs"/>
										kakao<strong>talk</strong> 보내기</button></a>
									...
									<a href="serviceInfo.do"><button type="button"
										...
										서비스신청내역</button></a>
									<a href="serviceExtend.do"><button type="button"
											class="btn btn-complete">
										<img src="./img/content/complete/icon_5_long.png" height="20px" width="25px"/>
										기간연장하기</button></a>
								</div>
								<div class="pt-4">
									<a href="contentEditForm.do?urlId=${content.urlId}"><button type="button"
												class="btn btn-lg btn-complete-center">
