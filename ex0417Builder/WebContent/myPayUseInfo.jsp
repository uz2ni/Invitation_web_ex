...
<body>
	...
	<!-- serviceInfo view -->
	<article class="center col-8" style="padding:0;"> <!-- 탭 -->
		...
		<div class="d-flex Info-tabs">
			...
			<div class="tabbable" style="width: 100%;">
				<ul class="nav Info-nav-tabs">
					...
					<li class="active"><a href="#tab3" data-toggle="tab">서비스
							신청내역</a></li>
				</ul>
				<div class="tab-content text-center">
							...
							<div class="col-12">
								<form class="row justify-content-end py-2">
									<div class="d-flex px-2 pt-2">
										<h5 class="">
											남은 우표(포인트) : <span class="">${user.userPoint}</span> 장
										</h5>
									</div>
									<div class="">
										<a href="messagePay.do"><button type="button" class="btn"
												style="background: #333333; color: white;">충전하기</button></a>
									</div>
								</form>
								<!--잔여포인트_end-->
								<!--table-->
					...
					<div class="tab-pane active" id="tab3">
						<div class="row py-3">
							...
							<!--table_end-->
							<div class="mx-auto">
								<a href="application_2.html"><button type="button"
										class="btn btn-lg info-btn">초대장 추가하기</button></a> <a
									href="extension.html"><button type="button"
										class="btn btn-lg info-btn">사용기간 연장하기</button></a>
							</div>
						</div>
					</div>
				</div>
